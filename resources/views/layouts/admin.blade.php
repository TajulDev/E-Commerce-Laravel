    ...
    <div class="container-scroller">
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ route('admindashboard') }}"><img src="{{asset('asset/images/logo.svg')}}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="{{ route('admindashboard') }}"><img src="{{asset('asset/images/logo-mini.svg')}}" alt="logo" /></a>
        </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="">Registered Customers</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('producttable') }}">Products List</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="forms">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('addproduct') }}">Pruduct Add</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
